...
![Halaman Sign Up Agent Router](/blog/agent-router/1-continue-with-github.png)
...
![Saldo Agent Router](/blog/agent-router/2-claim-balance.png)
...
![Menu API Token](/blog/agent-router/3-api-token.png)
![Create Token](/blog/agent-router/4-create-token.png)

Isi nama token dengan `KiloCode`. Untuk bagian Token grouping, Expiration time, dan New Quantity biarkan default.

![Isi Nama Token](/blog/agent-router/5-isi-nama-token.png)
...
![Aktifkan Unlimited Quota](/blog/agent-router/6-unlimited-and-submit.png)

Token akan muncul setelah klik Submit. *Copy* API Key yang berawalan `sk-xxx...`.

![Get API Key](/blog/agent-router/7-api-key.png)
...
![Install KiloCode](/blog/agent-router/8-install-kilocode.png)

Setelah terinstall, KiloCode akan tersedia di Sidebar VSCode. Buka panel KiloCode lalu klik **ikon pengaturan**.

![Pengaturan KiloCode](/blog/agent-router/9-pengaturan-kilocode.png)

Klik **Providers** dan pilih **Custom Provider**.

![Custom Provider](/blog/agent-router/10-custom-provider.png)
...
![Setting Provider](/blog/agent-router/11-setting-provider.png)
![Setting Provider](/blog/agent-router/12-setting-provider2.png)

> **Tips:** Model yang disediakan oleh Agent Router dapat kamu cek pada saat Create Token sebelumnya.

![Models](/blog/agent-router/13-models.png)

Simpan pengaturan dengan klik **Submit**. Sekarang KiloCode sudah terhubung ke Agent Router dan siap digunakan!

![Setup di KiloCode](/blog/agent-router/14-kilocode-ready.png)
...
![Persiapan](/blog/agent-router/15-tutor1.png)
...
![Mode Agent](/blog/agent-router/16-tutor2.png)
...
![Prompt Plan](/blog/agent-router/17-tutor3.png)
...
![Pertanyaan Agent](/blog/agent-router/18-tutor4.png)
![Diskusi dengan Agent](/blog/agent-router/19-tutor5.png)
![Hasil Diskusi](/blog/agent-router/20-tutor6.png)
...
![Folder .kilo](/blog/agent-router/22-tutor8.png)
...
![Eksekusi Code](/blog/agent-router/21-tutor7.png)
...
![Hasil ToDo List](/blog/agent-router/23-tutor9.png)
![Tampilan Aplikasi](/blog/agent-router/24-tutor10.png)
![Dashboard Usage](/blog/agent-router/25-tutor11.png)
