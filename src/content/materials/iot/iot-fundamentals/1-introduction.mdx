---
title: "1 - Event Pattern"
description: "Event Pattern - IoT fundamentals"
category: "IoT"
difficulty: "Beginner"
pubDate: 2025-09-01
author: "Hudya @perogeremmer"
curriculumSlug: "iot-fundamentals"
order: 1
estimatedTime: "40 minutes"
tags: ["iot", "embedded", "beginner"]
---
...
![Alt text](/materials/iot/assets/1-introduction/1.png)
...
![Alt Text](/materials/iot/assets/1-introduction/3.jpeg)

Habis itu kalian klik "yes" dan akan muncul tampilan seperti dibawah ini

![Alt Text](/materials/iot/assets/1-introduction/4.png)
...
![Alt Text](/materials/iot/assets/1-introduction/5.png)
...
![Alt Text](/materials/iot/assets/1-introduction/6.png)
...
![Alt Text](/materials/iot/assets/1-introduction/7.png)
...
![Alt Text](/materials/iot/assets/1-introduction/8.png)
...
![Alt Text](/materials/iot/assets/1-introduction/9.png)
...
![Alt Text](/materials/iot/assets/1-introduction/10.gif)
...
![Alt Text](/materials/iot/assets/1-introduction/11.png)
...
![Alt Text](/materials/iot/assets/1-introduction/12.png)

Jika sudah masukkan password, akan muncul tampilan jadi seperti ini

![Alt Text](/materials/iot/assets/1-introduction/13.png)
...
&gt; ![Alt Text](/materials/iot/assets/1-introduction/ssh.jpeg)
...
![Alt Text](/materials/iot/assets/1-introduction/15.gif)
...
![Alt Text](/materials/iot/assets/1-introduction/16.png)
...
![Alt Text](/materials/iot/assets/1-introduction/17.png)
...
![Alt Text](/materials/iot/assets/1-introduction/18.gif)
...
![Alt Text](/materials/iot/assets/1-introduction/19.gif)
