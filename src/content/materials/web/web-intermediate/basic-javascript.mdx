...
description: "JavaScript Basics - Web Development reference"
category: "Web Development"
difficulty: "Intermediate"
pubDate: 2025-09-01
author: ": M.Fauzan Arrafi"
estimatedTime: "20 minutes"
tags: ["web", "javascript", "reference"]
---
...
Here, we create a new `` element, set its text content, and then append it to an existing `` element with the ID "myDiv".
