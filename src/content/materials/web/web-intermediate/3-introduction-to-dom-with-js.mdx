...
description: "Document Object Model - Web Development intermediate material"
...
Di sini, kita membuat elemen baru ``, mengatur konten teksnya, dan kemudian menambahkannya ke elemen `` yang sudah ada dengan ID "myDiv".
...
<body>
    ...
    Press any key on your keyboard to see the alert.
