...
description: "- Pengenalan Laravel - Laravel framework material"
...
![](/materials/web/assets/Pengenalan-Laravel/Laravel-Logo.png)
...
3. **Verifikasi Instalasi:** Buka command prompt atau terminal dan jalankan perintah berikut untuk memastikan Composer telah terinstal dengan benar:
    ...
    ![](/materials/web/assets/Pengenalan-Laravel/Composer.png)
...
![](/materials/web/assets/Pengenalan-Laravel/Laravel-Mulai.png)
...
![](/materials/web/assets/Pengenalan-Laravel/Hello-Word.png)
