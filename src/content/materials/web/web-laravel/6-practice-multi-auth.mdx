---
title: "Implementasi Multi-Auth di Laravel 11 dengan Breeze"
description: "Implementasi Multi-Auth di Laravel 11 dengan Breeze - Laravel framework material"
...
1. Buat database baru di MySQL:
   ...
   ![](/materials/web/assets/Praktek-Multi-Auth/buat-database.png)
...
2. Edit file `.env` di root proyek:
   ...
   ![](/materials/web/assets/Praktek-Multi-Auth/set-env.png)
...
- Registrasi sebagai user dan admin
    ![](/materials/web/assets/Praktek-Multi-Auth/test-register.gif)
- Login sebagai user dan admin
    ![](/materials/web/assets/Praktek-Multi-Auth/test-login.gif)
