---
title: "**Chapter 1: Pengenalan**"
description: "**Chapter 1: Pengenalan** - Web Development reference"
...
Tag HTML \&lt;h\&gt; yang Anda sebutkan tidak merupakan tag standar dalam HTML. Biasanya, tag untuk judul (heading) dalam HTML adalah \, \, \, \, \, atau \, di mana angka yang mengikuti \"h\" menunjukkan tingkat kepentingan atau ukuran teks yang berbeda. Kamu dapat mencobanya dengan memasukan kode berikut kedalam \&lt;body\&gt;.
...
<h1>Ini adalah h1</h1>
 ...
 ini adalah paragraf. ini adalah paragraf.ini adalah paragraf. 
...
**ordered list \**, adalah sebuah list dimana data yang kamu masukan akan terurut menggunakan angka/huruf.
...
**Unordered list \**, adalah sebuah list yang tidak mengurutkan data yang dimasukan dan hanya menggunakan dot/bullet sebagai indikator.
...
Digunakan untuk membuat tautan ke halaman web lain, berkas, atau alamat URL lainnya. Ini memungkinkan pengguna untuk mengeklik tautan dan beralih ke lokasi yang dituju. Elemen \ sering digunakan untuk membuat tautan teks atau gambar. Untuk mencobanya, ikuti langkah langkah berikut:

Step 1: buat file "contohAnchor.html" pada folder projek mu

Step 2: masukan kode \ Ini adalah tautan
