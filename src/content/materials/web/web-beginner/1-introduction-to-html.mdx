---
title: "Introduction"
description: "Introduction - Web Development beginner material"
...
![](/materials/web/assets/2.png)

Step 2: Klik "open folder"

![](/materials/web/assets/3.png)
...
![](/materials/web/assets/structure.png)
...
<body>
    ...
    <h1>Ini adalah h1</h1>
    Ini adalah paragraf pertama. HTML adalah bahasa markup yang digunakan untuk membuat halaman web.
    Ini adalah paragraf kedua. HTML terdiri dari elemen-elemen yang diapit oleh tanda kurung sudut.
</body>
</html>
```
...
<body>
    <h1>Ini adalah h1</h1>
    <h2>Ini adalah h2  dengan  break</h2>
    
    Ini adalah paragraf pertama tapi dengan break.  HTML adalah bahasa  markup yang digunakan untuk membuat   halaman web.
    Ini adalah paragraf kedua. HTML terdiri dari elemen-elemen yang diapit oleh tanda kurung sudut.
</body>
</html>
```

Baik `` maupun ``, keduanya sama-sama dapat digunakan
...
- Ordered List: Sebuah list dimana data yang kamu masukan akan terurut menggunakan angka/huruf. Ordered list digambarkan dengan tag ``.
- Unordered List: Sebuah list yang tidak mengurutkan data yang dimasukan dan hanya menggunakan dot/bullet sebagai indikator. Ordered list digambarkan dengan tag ``.
...
<body>
    <div>
        ...
        Gambar di atas adalah Steve dari Minecraft.
        <img src="https://via.placeholder.com/150" alt="Placeholder Image"/>
        Gambar di atas adalah gambar placeholder.
    </div>
</body>
</html>
```
...
Tag Anchor digunakan untuk membuat tautan ke halaman web lain, berkas, atau alamat URL lainnya. Ini memungkinkan pengguna untuk menekan tautan dan beralih ke lokasi yang dituju. Elemen `` sering digunakan untuk membuat tautan teks atau gambar. Untuk mencobanya, ikuti langkah langkah berikut:
...
<body>
    ...
    Ini adalah contoh halaman pertama.
...
<body>
    ...
    Ini adalah contoh halaman kedua.
