---
title: "Part 3 — Templating"
description: "Part 3 — Templating - Web Development advanced material"
category: "Web Development"
difficulty: "Advanced"
pubDate: 2025-09-01
author: ": Pak Hudya"
curriculumSlug: "web-advance"
order: 3
estimatedTime: "45 minutes"
tags: ["web", "php", "mvc", "advanced"]
---
...
```php
<footer>
    &copy; 2024 Website Templating. All rights reserved.
</footer>
</body>
</html>
```
...
<?php include 'header.php'; ?>
    <main>
        ...
        Ini adalah konten utama halaman home.
    </main>
...
![Alt text](/materials/web/assets/part-3/1.png)
...
<div class="container">
    ...
    Which is more difficult, coding or counting? Not both of them, the difficult one is sharing your knowledge with people without asking for the payment.  <small>- Hudya</small>
    Kunjungi blog belajar bareng Hudya dengan akses gratis <a href="https://hudya.xyz ">disini</a>.
</div>
```
...
![Alt text](/materials/web/assets/part-3/2.png)
