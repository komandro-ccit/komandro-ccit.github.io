---
title: "Part 1 - Pengenalan PHP NATIVE"
description: "Part 1 - Pengenalan PHP NATIVE - Web Development advanced material"
...
![Alt text](/materials/web/assets/part-1/1.png)
...
<html>
    ...
    <body>
        Halo, nama saya <?= $name ?>
        Usia saya adalah <?php echo $age ?> tahun
        Tinggi saya adalah <?php echo $height ?> meter
        Saya adalah pelajar: <?php echo $isStudent ? 'Ya' : 'Tidak'; ?>
        Hobi saya adalah:
        <ul>
            <?php 
...
![Alt text](/materials/web/assets/part-1/2.png)
