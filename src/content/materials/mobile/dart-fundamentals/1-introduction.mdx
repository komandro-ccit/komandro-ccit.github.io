...
description: "Introduction to Dart - Dart programming fundamentals"
category: "Mobile Development"
difficulty: "Beginner"
pubDate: 2025-09-01
author: "Komandro Team"
curriculumSlug: "dart-fundamentals"
order: 1
estimatedTime: "40 minutes"
tags: ["dart", "mobile", "beginner"]
---
...
- Kunjungi situs resmi Dart di [dart.dev](https://dart.dev/get-dart/archive) dan unduh Dart SDK untuk sistem operasi Anda.
   <img src="/materials/mobile/assets/dart-sdk-download.gif" width="1000" />

### 2. Ekstrak SDK

- Ekstrak file yang diunduh ke direktori pilihan Anda.
      <img src="/materials/mobile/assets/dart-sdk-extract.gif" width="1000" />
...
- salin directory `bin` dark Dart SDK yang sudah kamu extract.
      <img src="/materials/mobile/assets/dart-sdk-copy-bin.gif" width="1000" />
...
![Alt text](/materials/mobile/assets/env-variable.png)

- Pilih **advanced** dan click **Enviorment Variable**
      <img src="/materials/mobile/assets/env-variable.gif" />

- Click **Path**, click **New** dan **Paste** directory `bin` Dart SDK yang sudah kamu **Salin**, lalu click **OK** untuk save.
      <img src="/materials/mobile/assets/dart-sdk-paste-path.gif" />
...
- Buka terminal atau command prompt dan jalankan perintah berikut untuk memastikan Dart telah terinstal dengan benar:
   ...
   ![alt text](/materials/android/material/assets/dart-version.png)
...
![alt text](/materials/android/material/assets/instalasi-vscode.png)
...
![alt text](/materials/android/material/assets/dart-extension.gif)
...
![alt text](/materials/android/material/assets/dart-create-folder.gif)
...
![alt text](/materials/android/material/assets/dart-open-folder.gif)
...
![alt text](/materials/android/material/assets/dart-run.gif)
