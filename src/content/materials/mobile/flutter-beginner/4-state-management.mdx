...
description: "State Management Dasar - Flutter beginner material"
...
```
<img src="/materials/mobile/assets/set-state.gif" width="300" />
...
```
<img src="/materials/mobile/assets/inherited-widget.gif" width="300" />
